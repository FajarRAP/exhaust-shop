        ...
        <div class="flex h-16 justify-between">
            ...
            <div class="hidden sm:ms-6 sm:flex sm:items-center">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="focus:outline-hidden inline-flex items-center rounded-md border border-transparent bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out hover:text-gray-700">
                    ...
                    <x-slot name="content">
                        ...
                        @if (auth()->user()?->isAdmin())
                            <x-dropdown-link class="font-bold text-indigo-600" :href="route('admin.dashboard')">
